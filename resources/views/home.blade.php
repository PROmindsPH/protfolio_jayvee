...
<body class="bg-[#0f172a] text-white font-sans pt-24">

<!-- NAVBAR -->
<nav class="fixed top-0 w-full z-50 bg-[#0f172a] shadow-md" x-data="{ open: false }">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            <a href="{{ route('home') }}" class="flex items-center space-x-3">
                <img src="{{ asset('images/jayveeLogo_WNoBG.png') }}" alt="Logo" class="w-8 h-8">
                <h1 class="hidden md:block text-lg font-bold text-white">John Vince Paisan</h1>
            </a>
    ...
    <div x-show="open" x-transition x-cloak class="md:hidden px-4 pb-4 space-y-2 text-gray-300 bg-[#0f172a]">
...
<section class="flex flex-col md:flex-row items-center justify-between px-4 md:px-8 mt-6">
    ...
    <div class="w-full md:w-1/2 mt-8 md:mt-0 flex justify-center">
        <div class="relative w-64 h-64 md:w-[430px] md:h-[430px] flex items-center justify-center">
            ...
            <div 
                class="absolute inset-0 rounded-full z-0 opacity-100 blur-md border-4 border-white"
                style="background: url('/images/jayvee_BG.png') no-repeat center; background-size: cover;">
            </div>

            <!-- Profile image -->
            <img src="/images/jayveeProfile.png" alt="Jayvee" class="rounded-full w-full h-full object-cover relative z-10" />
        </div>
    </div>
</section>
